...
namespace ProjetoAulaYuriWpf.Models.Personagem.Perfil
{
    ...
    /// Classe Guerreiro
    /// </summary>
    public class Guerreiro : PerfilJogador // classe base.
    {
        /// <summary>
        /// Construtor Padrão
        /// </summary>
        ...
        {
            get => base.ClassePersonagem = this.GetType().Name;
            internal set => base.ClassePersonagem = this.GetType().Name;
        }
    ...
    /// Classe Mago
    /// </summary>
    public class Mago : PerfilJogador // Herança
    {
        /// <summary>
        /// Construtor Padrão
        /// </summary>
    ...
    /// Classe Necromante
    /// </summary>
    public class Necromante : PerfilJogador
    {
